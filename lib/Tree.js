...
var Tree = module.exports = function(location, relativeTo, TreeContext) {
...
Tree.prototype.watchGlobs = function(globCollection) {
...
Tree.prototype.mapGlobs = function(globCollection) {
	if (!(globCollection instanceof GlobCollection)) {
		var globs = [];
		for (var i = 0, l = arguments.length; i < l; i++) {
			if (arguments[i] instanceof GlobCollection) {
...
Tree.prototype._populate = function() {
